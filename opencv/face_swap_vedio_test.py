    ...
    def start(self):
        while self.video.isOpened():
            ...
            if dst_points is not None:
                dst_img = face_swap(self.src_face, dst_face, self.src_points, dst_points, dst_shape, dst_img, self.args,
                                    68)
...
if __name__ == '__main__':
    ...
    args.src_img = ori_img
    args.video_path = "vedios/test.avi"
    args.warp_2d = False
    args.correct_color = False
    args.show = False
    args.save_path = "output2/test.avi"
